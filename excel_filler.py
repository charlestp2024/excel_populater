...
SUBDOCKET_FILING_TYPES = [
    ...
    "Continuation Patent",
    "Divisional",
    "Continuation-In-Parts / Patent of addition",
]
COUNTRIES = {
    "IN": "India",
    "CN": "China",
...
ALL_COLUMNS = [
    ...
    "Subdocket Foreign Filing Countries",
    "Status",
        ...
        sub_docket_row.update(
            {
                ...
                "Subdocket Foreign Filing Countries": ", ".join(
                    random.sample(COUNTRY_CODES, k=random.randint(2, 5))
                ),
                "Subdocket Filing & Maintenance Cost Estimate": round(
                    random.uniform(10000.00, 100000.00), 2
                ),
